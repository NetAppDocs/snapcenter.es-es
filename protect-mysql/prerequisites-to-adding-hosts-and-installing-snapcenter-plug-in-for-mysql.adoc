...
summary: Antes de añadir un host e instalar los paquetes de plugins, debe cumplir con todos los requisitos. Plugin SnapCenter para MySQL está disponible en entornos Windows y Linux. 
---
= Requisitos previos para añadir hosts e instalar el complemento SnapCenter para MySQL
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
* Debes tener instalado Java 17 (Oracle Java, OpenJDK o SAP JDK) para SnapCenter 6.2.1 y posteriores, o Java 11 para SnapCenter 6.2 y anteriores en tu host.
+
...
* Si utiliza una versión de MySQL anterior a la 8.0, deberá instalar y habilitar manualmente el complemento MySQLX. El complemento MySQLX viene instalado y habilitado de forma predeterminada en MySQL 8.0 y versiones posteriores.
...
* Debes tener instalado Java 17 (Oracle Java, OpenJDK o SAP JDK) para SnapCenter 6.2.1 y versiones posteriores o Java 11 para SnapCenter 6.2 y versiones anteriores en tu host con Windows.
+
link:https://www.oracle.com/java/technologies/downloads/#java17["Descargar Java para todos los sistemas operativos"]
...
* Debe haber habilitado la conexión SSH por contraseña para el usuario raíz o no raíz.
* Debes tener instalado Java 17 (Oracle Java, OpenJDK o SAP JDK) para SnapCenter 6.2.1 y versiones posteriores o Java 11 para SnapCenter 6.2 y versiones anteriores en tu host Linux.
+
link:https://www.oracle.com/java/technologies/downloads/#java17["Descargar Java para todos los sistemas operativos"]
...
Para ejecutar un comando complementario en el plugin de SnapCenter para MySQL, debe incluirlo en el archivo _allowed_commands.config_.
