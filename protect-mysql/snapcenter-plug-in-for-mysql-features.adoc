...
summary: SnapCenter se integra con la aplicación de plugins y con tecnologías de NetApp en el sistema de almacenamiento. Para trabajar con el plugin para base de datos MySQL, se utiliza la interfaz gráfica de usuario de SnapCenter. 
---
= Funciones del plugin de SnapCenter para MySQL
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
SnapCenter se integra con la aplicación de plugins y con tecnologías de NetApp en el sistema de almacenamiento. Para trabajar con el plugin para base de datos MySQL, se utiliza la interfaz gráfica de usuario de SnapCenter.
...
+
SnapCenter utiliza la tecnología de snapshots de NetApp con el plugin para bases de datos de MySQL para realizar backups de recursos.



Usar el plugin para MySQL también ofrece los siguientes beneficios:
