...
---
= Crea políticas de backup para MySQL con SnapCenter
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
Consulte link:view-mysql-database-backups-and-clones-in-the-topology-page.html["Consulte los backups y los clones relacionados con los recursos de MySQL en la página Topology"].
