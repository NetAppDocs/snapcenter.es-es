...
---
= Requisitos previos para añadir hosts e instalar los complementos de SnapCenter
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
* Debes tener instalado Java 17 (Oracle Java, OpenJDK o SAP JDK) para SnapCenter 6.2.1 y posteriores, o Java 11 para SnapCenter 6.2 y anteriores en tu host Linux, Windows o AIX.
+
...
+
link:https://www.oracle.com/java/technologies/downloads/#java17["Descargar Java para Windows"]
...
+
Si estás usando Windows Server 2019 o Windows Server 2016 para el host de SnapCenter Server, debes instalar Java 17 (Oracle Java, OpenJDK o SAP JDK) para SnapCenter 6.2.1 y posteriores, o Java 11 para SnapCenter 6.2 y anteriores.

+
link:https://www.oracle.com/java/technologies/downloads/#java17["Descargar Java para Linux"]
...
Paquetes de software obligatorios
 a| 
* Java 17 para SnapCenter 6.2.1 y posteriores, IBM Java o Java 11 para SnapCenter 6.2 y anteriores, IBM Java
