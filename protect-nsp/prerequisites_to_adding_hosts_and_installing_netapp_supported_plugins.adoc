...
* Debes tener instalado Java 17, Java 11 (solo para SnapCenter 6.2) en tu host Linux, Windows o AIX.
+
...
+
Si utilizas Windows Server 2019 o Windows Server 2016 para el host de SnapCenter Server, debes instalar Java 17, Java 11 (solo para SnapCenter 6.2).
...
Paquetes de software obligatorios
 a| 
Java 17, Java 11 (solo para SnapCenter 6.2), IBM Java
