...
* Debes tener instalado Java 17 en tu host Linux, Windows o AIX.
+
...
+
Si utilizas Windows Server 2019 o Windows Server 2016 para el host de SnapCenter Server, debes instalar Java 17.
