...
* Debes tener instalado Java 17 (Oracle Java u OpenJDK) para SnapCenter 6.2.1 y versiones posteriores o
* Java 11 para SnapCenter 6.2 y anteriores en tu host Linux, Windows o AIX.
+
...
+
Si estás usando Windows Server 2019 o Windows Server 2016 para el host del servidor de SnapCenter, debes instalar Java 17 (Oracle Java u OpenJDK) para SnapCenter 6.2.1 y posteriores o Java 11 para SnapCenter 6.2 y anteriores.
...
Paquetes de software obligatorios
 a| 
* Java 17 para SnapCenter 6.2.1 y posteriores, IBM Java o
* Java 11 para SnapCenter 6.2 y anteriores, IBM Java
