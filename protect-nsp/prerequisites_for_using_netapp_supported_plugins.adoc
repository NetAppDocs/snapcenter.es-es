...
* Si aplica, instala Java 17 (Oracle Java u OpenJDK) para SnapCenter 6.2.1 y posteriores o
* Java 11 para SnapCenter 6.2 y anteriores en el host del complemento.
