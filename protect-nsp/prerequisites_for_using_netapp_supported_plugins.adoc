...
---
= Requisitos previos para usar los complementos compatibles con NetApp con SnapCenter
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
* Si procede, instala Java 17 (Oracle Java, OpenJDK o SAP JDK) para SnapCenter 6.2.1 y posteriores o Java 11 para SnapCenter 6.2 y anteriores en el host del complemento.
