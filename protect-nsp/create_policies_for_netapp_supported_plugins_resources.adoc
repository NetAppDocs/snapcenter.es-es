...
---
= Crea políticas de SnapCenter para los recursos de complementos compatibles con NetApp
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
Consulte link:view_netapp_supported_plugins_resource_backups_and_clones_in_the_topology_page.html["Ver los clones y backups relacionados con los recursos de plugins admitidos en NetApp en la página Topology"].
