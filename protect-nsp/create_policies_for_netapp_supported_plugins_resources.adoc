...
Consulte link:protect-nsp/view_custom_plug_in_resource_backups_and_clones_in_the_topology_page.html["Ver los clones y backups relacionados con los recursos de plugins admitidos en NetApp en la página Topology"].
