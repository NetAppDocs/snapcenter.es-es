...
* ORACLE_EXPORT_PARAMETERS especifica si se pueden exportar variables de entorno mientras se ejecuta _bin/su_. El valor de ORACLE_EXPORT_PARAMETERS debe establecerse en *y*.
