...
summary: Debe crear roles de SVM si configura SVM en sistemas ASA R2 para su uso con SanpCenter y no desea usar el rol vsadmin. 
---
...
[role="lead"]
Hay varios comandos de la CLI de ONTAP que debe ejecutar para crear un rol para un usuario de SVM nuevo en los sistemas ASA R2. Este rol es obligatorio si configura SVM en sistemas ASA R2 para su uso con SnapCenter y no desea utilizar el rol vsadmin.
