...
NOTE: Desde SnapCenter 5,0, los usuarios de administradores de clústeres solo son compatibles con las API REST. Si desea crear roles con un administrador que no sea del clúster, debe usar ZAPI.
