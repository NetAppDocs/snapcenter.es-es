...
summary: Debe crear un rol de clúster de ONTAP con privilegios mínimos para poder no usar el rol de administrador de ONTAP para realizar operaciones en SnapCenter. 
---
...
NOTE: A partir de SnapCenter 5,0, los usuarios de administradores de clúster solo son compatibles con las API REST. Si desea crear roles con un administrador que no sea del clúster, debe usar ZAPI.
