...
La licencia estándar de SnapCenter es una licencia basada en controladora y se incluye como parte de ONTAP. Si tiene la licencia de conjunto de SnapManager, también obtendrá el derecho de licencia estándar de SnapCenter. Si desea instalar SnapCenter a modo de prueba con almacenamiento FAS, AFF o ASA, puede obtener una licencia de evaluación de ONTAP One poniéndose en contacto con el representante de ventas.

Para obtener información sobre las licencias incluidas con ONTAP One, consulte https://docs.netapp.com/us-en/ontap/system-admin/manage-licenses-concept.html#licenses-included-with-ontap-one["Licencias incluidas con ONTAP One"] .
