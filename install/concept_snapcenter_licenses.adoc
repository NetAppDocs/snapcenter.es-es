...
NOTE: Las licencias avanzada y SnapCenter de servicios de archivos NAS de SnapCenter quedaron obsoletas y ya no están disponibles. Esta licencia basada en la capacidad ya no se requiere para Amazon FSx para NetApp ONTAP y Cloud Volumes ONTAP.
