...
Para simplificar la configuración de estos roles en sistemas de almacenamiento, puede usar la herramienta Creador de usuarios de RBAC para NetApp ONTAP, que se encuentra en el foro de comunidades de NetApp.
