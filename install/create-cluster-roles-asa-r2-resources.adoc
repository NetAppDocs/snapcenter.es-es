...
summary: Debe crear roles de clúster de ONTAP para los sistemas ASA R2 de modo que no tenga que usar el rol de administrador de ONTAP para realizar operaciones en SnapCenter. 
---
= Crear roles de clúster ONTAP para sistemas ASA r2 en SnapCenter
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
