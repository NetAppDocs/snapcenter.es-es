...
---
= Instala el servidor SnapCenter en un host con Windows
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
Si lo deseas, puedes realizar varios procedimientos de instalación y configuración usando los cmdlets de PowerShell. Deberías estar usando PowerShell 7.4.13 o una versión posterior.
...
** Paquete de alojamiento de ASP.NET Core 10.0.7 (o posterior) Consulta la link:https://library.netapp.com/ecm/ecm_download_file/ECMLP3359467["SnapCenter software Notas de la versión"^] para conocer las últimas versiones calificadas de ASP.NET Core para tu versión específica de SnapCenter.
...
+
** Activación de TCP
** Activación de HTTP Consulta el link:https://library.netapp.com/ecm/ecm_download_file/ECMLP3359467["SnapCenter software Notas de la versión"^] para las últimas versiones certificadas de ASP.NET Core para tu versión específica de SnapCenter.
