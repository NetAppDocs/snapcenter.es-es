...
---
= SnapCenter aprovisionamiento de almacenamiento en entornos VMware
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
Consulta link:https://techdocs.broadcom.com["Documentación técnica de Broadcom"^] y busca documentación sobre la agrupación en clúster de máquinas virtuales entre hosts físicos y la creación de LUN compartidas FC RDM para clústeres de Microsoft.
