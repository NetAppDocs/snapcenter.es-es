...
+
Para obtener más información sobre Amazon FSX para ONTAP de NetApp, consulte https://["Documentación de Amazon FSX para ONTAP de NetApp"^].

* SnapCenter admite la protección de distintas aplicaciones y bases de datos.
+
Para obtener información detallada sobre las aplicaciones y bases de datos compatibles, consulte https://["Herramienta de matriz de interoperabilidad de NetApp"^].
