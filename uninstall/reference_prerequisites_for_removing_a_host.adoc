...
Para obtener más información sobre cómo desinstalar el plugin de SnapCenter para VMware vSphere, consulte https://["Quite el plugin de SnapCenter para VMware vSphere"^].
