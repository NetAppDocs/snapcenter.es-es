...
+
Se puede buscar el grupo de recursos ingresando su nombre en el cuadro de búsqueda o haciendo clic en image:../media/filter_icon.png["icono de filtro"] y seleccionando la etiqueta. A continuación, puede hacer clic en image:../media/filter_icon.png["icono de filtro"] para cerrar el panel de filtros.
