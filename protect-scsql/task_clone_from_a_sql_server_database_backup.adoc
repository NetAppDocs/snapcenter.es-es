...
+
Para EMS, consulte https://["Gestione la recogida de datos de EMS"]
...
https://["Es posible que la operación de clonado produzca errores o tarde más tiempo en finalizar con el valor TCP_TIMEOUT predeterminado"]

https://["Se produce un error en el clon de la base de datos de la instancia de clúster"]
