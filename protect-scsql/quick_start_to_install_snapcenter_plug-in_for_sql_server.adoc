...
Para ver los requisitos mínimos del ONTAP y el complemento de la aplicación, consulte https://["Herramienta de matriz de interoperabilidad"^]
...
Sistema operativo (64 bits)
 a| 
Consulte https://["Herramienta de matriz de interoperabilidad"^]
...
Para obtener información sobre el intervalo de puertos dinámicos admitido, consulte https://["Descripción general del servicio y requisitos de puertos de red para Windows"^].
...
. Descargue el paquete de instalación del servidor SnapCenter desde el https://["Sitio de soporte de NetApp"^] y, a continuación, haga doble clic en el archivo exe.
+
...
=== Añada una licencia estándar basada en controladora de SnapCenter
...
=== Añada una licencia basada en capacidad de SnapCenter
...
=== Configure las conexiones al sistema de almacenamiento
...
=== Configure credenciales Run As para instalar el plugin para Microsoft SQL Server
...
=== Añada un host e instale el plugin para Microsoft SQL Server
