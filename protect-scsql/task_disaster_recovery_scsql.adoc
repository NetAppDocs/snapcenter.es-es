...
---
= Recupera el complemento SnapCenter para SQL Server después de un desastre
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
* Implementa el complemento SnapCenter para SQL Server en un host alternativo usando la página *Agregar host* o *Modificar host*. Consulta link:https://docs.netapp.com/us-en/snapcenter/admin/concept_manage_hosts.html["Gestiona hosts en SnapCenter"] para más información.
