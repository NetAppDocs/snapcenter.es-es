...
NOTE: Para una configuración de F5, la operación de restauración se realiza como independiente, debe ejecutar un conjunto de comandos para volver a crear la F5. Consulte el enlace: https://["Cómo migrar SnapCenter a otro servidor"^]
