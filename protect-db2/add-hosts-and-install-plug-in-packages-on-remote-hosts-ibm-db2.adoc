...
+
link:../protect-db2/task_configure_gMSA_on_windows_server_2012_or_later.html["Configure la cuenta de servicio gestionado de grupo en Windows Server 2016 o posterior para IBM DB2"^]
...
.Después de terminar
Si desea actualizar a la versión SnapCenter 6,0, el plugin basado en PERL existente para DB2 se desinstalará del servidor de plugin remoto.
