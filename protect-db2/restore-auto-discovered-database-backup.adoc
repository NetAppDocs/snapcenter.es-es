...
---
= Restaurar y recuperar una copia de seguridad de una base de datos detectada automáticamente con SnapCenter
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
. En la página Restore Scope, seleccione *Complete Resource* para restaurar los volúmenes de datos configurados de la base de datos IBM DB2.
...
+
Los comandos de desmontaje no se requieren para los recursos detectados automáticamente.
...
+
Los comandos de montaje no se necesitan para los recursos detectados automáticamente.
