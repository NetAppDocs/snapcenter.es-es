...
---
= Agrega manualmente recursos de IBM Db2 al host del complemento SnapCenter
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
. En la página Recursos, selecciona *Add IBM DB2 Resource*.
...
Rutas de montaje
 a| 
Introduce las rutas de montaje donde está montado el recurso. Esto solo es aplicable a hosts Windows.
...
. Opcional: en la página Resource Settings, para recursos en hosts Linux donde esté instalado el SnapCenter Plug-in for IBM Db2, introduce pares clave-valor personalizados para el IBM Db2 plug-in. Los pares clave-valor personalizados no son compatibles con bases de datos IBM Db2 que estén registradas como un Windows plug-in centralizado.
. Revise el resumen y, a continuación, haga clic en *Finalizar*.
+
Las bases de datos se muestran junto con información como el nombre de host, los grupos de recursos y políticas asociados, y el estado general.
