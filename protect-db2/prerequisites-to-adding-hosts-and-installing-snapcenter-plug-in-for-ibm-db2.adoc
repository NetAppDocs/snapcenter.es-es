...
---
= Requisitos previos para añadir hosts e instalar el complemento SnapCenter para IBM Db2
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
* Debe haber habilitado la conexión SSH por contraseña para el usuario raíz o no raíz.
* Debes haber instalado Java 17 (Oracle Java, OpenJDK o SAP JDK) para SnapCenter 6.2.1 y versiones posteriores o Java 11 para SnapCenter 6.2 y versiones anteriores en tus hosts Linux o AIX.
+
link:https://www.oracle.com/java/technologies/downloads/#java17["Descargar Java para Linux"^]

+
link:https://developer.ibm.com/languages/java/semeru-runtimes/downloads/?license=IBM["Descargar Java para AIX"^]
