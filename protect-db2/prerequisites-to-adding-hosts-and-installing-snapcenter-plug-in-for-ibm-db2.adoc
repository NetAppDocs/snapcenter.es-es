...
+
link:https://www.oracle.com/java/technologies/javase/jdk11-archive-downloads.html["Descargar JAVA para Windows"^]
...
* Debe haber habilitado la conexión SSH por contraseña para el usuario raíz o no raíz.
* Debes haber instalado Java 11 en tus hosts Linux o AIX.
+
link:https://www.oracle.com/java/technologies/javase/jdk11-archive-downloads.html["Descargar JAVA para Linux"^]
