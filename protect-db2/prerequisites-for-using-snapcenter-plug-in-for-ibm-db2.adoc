...
---
= Requisitos previos para usar el complemento SnapCenter para IBM Db2
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
* Instala Java 17 (Oracle Java, OpenJDK o SAP JDK) para SnapCenter 6.2.1 y versiones posteriores o Java 11 para SnapCenter 6.2 y versiones anteriores en tu host Linux o Windows.
+
