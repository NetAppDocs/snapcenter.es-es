...
NOTE: Después de actualizar a SnapCenter 6.2.1 (servidor y plug-ins) y ONTAP 9.17.1, SnapCenter cambia los grupos de consistencia plana a grupos de consistencia jerárquica durante la primera copia de seguridad programada.
