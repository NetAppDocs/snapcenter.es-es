...
+
Para ONTAP 9.12.1 y versiones siguientes, los clones creados a partir de las copias snapshot de SnapLock heredarán el tiempo de caducidad de SnapLock Vault. El administrador de almacenamiento debe limpiar manualmente los clones después de la hora de caducidad de SnapLock.
