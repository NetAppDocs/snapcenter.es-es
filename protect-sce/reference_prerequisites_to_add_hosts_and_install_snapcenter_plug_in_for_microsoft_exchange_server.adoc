...
---
= Requisitos previos para instalar el complemento SnapCenter para Microsoft Exchange Server
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
* Debes estar usando Microsoft Exchange Server para configuraciones independientes y de Database Availability Group. Consulta la link:https://imt.netapp.com/imt/#search["Herramienta de matriz de interoperabilidad (IMT)"^] para ver las versiones compatibles de Microsoft Exchange Server.
...
* Asegúrate de que los siguientes puertos no estén bloqueados en el firewall, de lo contrario la operación de agregar host fallará. Para resolver este problema, debes configurar el rango dinámico de puertos. Para más información, consulta https://docs.microsoft.com/en-us/troubleshoot/windows-server/networking/configure-rpc-dynamic-port-allocation-with-firewalls["Documentación de Microsoft"^]. Consulta el link:https://imt.netapp.com/imt/#search["Herramienta de matriz de interoperabilidad (IMT)"^] para ver las versiones compatibles de Microsoft Exchange Server.
+
