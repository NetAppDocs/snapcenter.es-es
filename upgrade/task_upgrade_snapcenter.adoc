...
---
= Actualiza el servidor SnapCenter en un host de Windows
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
* Instala ASP.NET Core Runtime 10.0.7 Hosting Bundle (o una versión posterior) y PowerShell 7.6.1 (o una versión posterior).
+
