...
* Asegúrate de que ASP.NET Core Runtime 8.0.24 (y todos los parches posteriores 8.0.x) Hosting Bundle y PowerShell 7.4.13 o posterior estén instalados en el host del complemento de Windows.
* Asegúrate de que Java 17 (Oracle Java u OpenJDK) para SnapCenter 6.2.1 y posteriores, o Java 11 para SnapCenter 6.2 y anteriores, esté instalado en los hosts de complementos de Windows y Linux.
