...
** Si desea actualizar varios hosts de plugin, seleccione todos los hosts, haga clic en image:../media/more_icon.gif[""]y, a continuación, haga clic en *Actualizar* > *Aceptar*.
+
