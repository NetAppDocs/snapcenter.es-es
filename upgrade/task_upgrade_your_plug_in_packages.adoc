...
* Asegúrate de que PowerShell 7.4.13 está instalado en el host del plug-in de Windows.
* Asegúrate de que Java 17 (Oracle Java u OpenJDK) está instalado en los hosts de plug-in de Windows y Linux (o Java 11 solo para SnapCenter 6.2).
