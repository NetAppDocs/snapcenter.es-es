...
palabras clave: split clone, SnapCenter
Resumen: 'Puede utilizar SnapCenter para dividir un recurso clonado del recurso principal. El clon que se divide se independiza del recurso primario.'
----
= Dividir un clon
:icons: fuente
:imagesdir: ../media/
