...
---
= Crear grupos de recursos y asociar políticas a los sistemas de archivos UNIX en SnapCenter
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
NOTE: Para File System Consistent, se toman instantáneas de grupo de consistencia para los LUNs involucrados en el grupo de volúmenes.
...
NOTE: Si has añadido diferentes sistemas de archivos en el grupo de recursos, entonces todos los volúmenes de los diferentes sistemas de archivos en el grupo de recursos se colocan en un grupo de Consistencia. Para las copias de seguridad coherentes con fallos, se toma por defecto una instantánea del grupo de Consistencia aunque solo haya un sistema de archivos o un volumen.
