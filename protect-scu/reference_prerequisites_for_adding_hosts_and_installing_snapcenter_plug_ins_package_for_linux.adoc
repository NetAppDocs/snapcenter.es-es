...
---
= Requisitos previos para añadir hosts e instalar el paquete de complementos SnapCenter para Linux
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
NOTE: La clave RSA es el único formato de clave SSH compatible con SnapCenter. Consulta el artículo de base de conocimientos link:https://kb.netapp.com/data-mgmt/SnapCenter/SC_KBs/How_to_create_an_RSA_key_for_SnapCenter_SSH_Key_Based_credential["Cómo crear una clave RSA para la credencial basada en clave SSH de SnapCenter"^] para ver detalles sobre cómo crear la clave SSH.
...
* Debes haber instalado Java 17 para SnapCenter 6.2.1 y versiones posteriores o Java 11 para SnapCenter 6.2 y versiones anteriores en tu host Linux.
+
...
+
Para obtener información sobre las descargas de Java, consulta link:https://www.oracle.com/java/technologies/downloads/#java17["Descargar Java para todos los sistemas operativos"^].
...
|===
Para obtener la información más reciente sobre las versiones compatibles, consulta la  https://imt.netapp.com/imt/imt.jsp?components=180320;180338;&solution=1257&isHWU&src=IMT["Herramienta de matriz de interoperabilidad de NetApp"^].
