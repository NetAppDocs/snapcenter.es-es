...
** Datos en sistemas principales y secundarios ONTAP FAS, AFF o ASA y protegidos en el almacenamiento de objetos local de StorageGRID (mediante la integración del backup en el cloud de NetApp BlueXP).
...
** Datos en sistemas principales y secundarios de ONTAP FAS, AFF o ASA y protegidos para el almacenamiento de objetos y archivos en el cloud (mediante la integración de Cloud Backup de NetApp BlueXP)
