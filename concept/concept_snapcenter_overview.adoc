...
+
https://["Almacén de automatización del almacenamiento de NetApp"^]
...
+
Para obtener más información sobre las API de REST, consulte https://["Información general de la API de REST"].

+
Para obtener más información sobre cmdlets de Windows, consulte https://["Guía de referencia de cmdlets de SnapCenter Software"^].

+
Para obtener más información sobre comandos UNIX, consulte https://["Guía de referencia de comandos del software SnapCenter"^].
...
+
Los plugins personalizados son compatibles con la comunidad y pueden descargarse en el https://["Almacén de automatización del almacenamiento de NetApp"^].
...
Los ejemplos de plugins personalizados de MySQL, DB2 y MongoDB para el software SnapCenter se pueden descargar de https://["Almacén de automatización del almacenamiento de NetApp"^].
