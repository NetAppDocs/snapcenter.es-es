...
. Decidir si se desea crear una política basada en copias de Snapshot para realizar backup de las copias de Snapshot consistentes con las aplicaciones de la base de datos.
. Decidir si se verificará la integridad de la base de datos.
