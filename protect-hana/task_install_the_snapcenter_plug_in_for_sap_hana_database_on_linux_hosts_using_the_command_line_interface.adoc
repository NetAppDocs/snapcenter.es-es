...
---
= Instala el complemento SnapCenter para la base de datos SAP HANA en hosts Linux usando la CLI
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
El https://imt.netapp.com/imt/imt.jsp?components=180320;180336;&solution=1257&isHWU&src=IMT["Herramienta de matriz de interoperabilidad (IMT)"] Contiene la información más reciente sobre las configuraciones compatibles.
