...
+
La información relativa a los parámetros que se pueden utilizar con el cmdlet y sus descripciones se puede obtener ejecutando Get-Help _command_name_. Como alternativa, también puede consultar la https://["Guía de referencia de cmdlets de SnapCenter Software"]
...
+
Para obtener más información, consulte: https://["No es posible detectar la relación de SnapMirror o SnapVault tras un fallo en MetroCluster"^]
