...
---
= Crea grupos de recursos y asocia políticas para SnapCenter PostgreSQL
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
extensión_archivo
 a| 
Especifica la extensión del archivo de registro de archivo.

Por ejemplo, si el registro de archivo es log_backup_0_1.log, especifique .log como la extensión del archivo.
