...
---
= Requisitos previos para usar el complemento SnapCenter para PostgreSQL
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
* Instala Java 17 (para SnapCenter 6.2.1 y posteriores) o Java 11 (para SnapCenter 6.2 y anteriores) en tu host Linux o Windows.
+
