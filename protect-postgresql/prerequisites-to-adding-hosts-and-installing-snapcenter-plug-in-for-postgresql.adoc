...
* Debes tener instalado Java 17 (para SnapCenter 6.2.1 y versiones posteriores) o Java 11 (para SnapCenter 6.2 y versiones anteriores) en tu host.
+
...
* Debes tener instalado Java 17 (para SnapCenter 6.2.1 y versiones posteriores) o Java 11 (para SnapCenter 6.2 y versiones anteriores) en tu equipo host con Windows.
+
