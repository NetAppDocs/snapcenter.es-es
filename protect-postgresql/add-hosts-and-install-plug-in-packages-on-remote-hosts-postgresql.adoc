...
+
link:../protect-postgresql/task_configure_gMSA_on_windows_server_2012_or_later.html["Configure la cuenta de servicio administrada de grupo en Windows Server 2016 o posterior para PostgreSQL"^]
