...
. Haga image:../media/more_icon.gif["icono más"] clic y haga clic en *Iniciar servicio* o *Reiniciar servicio*.
+
...
. Haga clic en image:../media/more_icon.gif["icono más"]y, a continuación, en *Suspender programación* para colocar el host de este plugin en modo de mantenimiento.
+
