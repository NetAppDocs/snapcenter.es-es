...
.Antes de empezar
* Debes haber instalado ASP.NET Core Runtime 10.0.7 Hosting Bundle (o una versión posterior).
* Debes haber instalado PowerShell 7.6.1 (o una versión posterior).
