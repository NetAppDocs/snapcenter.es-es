...
+
Si ninguna política cumple con sus requisitos, puede crear una nueva haciendo clic en *image:../media/add_policy_from_resourcegroup.gif[""]* para iniciar el asistente de políticas.
