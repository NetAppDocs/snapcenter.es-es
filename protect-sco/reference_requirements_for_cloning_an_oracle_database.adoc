...
+
Para obtener información sobre cómo editar el parámetro asm_diskstring, consulte https://["Cómo agregar las rutas de acceso al disco a asm_diskstring"^].
...
+
**** https://["Guía de instalación y configuración de Linux Host Utilities"^]
**** https://["Guía de instalación y configuración de AIX Host Utilities"^]
