...
---
= Descubre las estrategias de restauración y recuperación de bases de datos Oracle en SnapCenter
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
* Restauración de archivos temporales porque el complemento para Oracle no realiza copias de seguridad de los archivos temporales.
