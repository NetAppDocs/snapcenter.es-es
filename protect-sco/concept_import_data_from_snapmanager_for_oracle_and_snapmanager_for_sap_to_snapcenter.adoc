...
---
= Cómo SnapCenter importa datos de SnapManager para Oracle y SAP
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
Las configuraciones compatibles con el complemento SnapCenter para Oracle Database se enumeran en el siguiente documento: https://imt.netapp.com/imt/imt.jsp?components=180320;180338;180332;&solution=1257&isHWU&src=IMT["Herramienta de matriz de interoperabilidad de NetApp"^].
