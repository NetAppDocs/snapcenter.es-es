...
---
= Divide un clon de base de datos conectable en SnapCenter
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
. Seleccione el clon de PDB (targetCDB:PDBClone) y, a continuación, haga clic en image:../media/split_clone.gif["dividir clon"].
