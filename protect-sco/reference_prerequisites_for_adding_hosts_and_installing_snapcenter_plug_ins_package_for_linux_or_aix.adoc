...
* Debes tener instalado Java 17 en tu host Linux o AIX.
+
...
NOTE: Asegúrate de haber instalado únicamente la edición certificada de Java 17 en el host Linux.
