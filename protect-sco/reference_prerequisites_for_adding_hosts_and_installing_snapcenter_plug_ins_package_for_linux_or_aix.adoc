...
* Debes tener instalado Javva 17, Java 11 (solo para SnapCenter 6.2) en tu host Linux o AIX.
+
...
NOTE: Asegúrate de haber instalado únicamente la edición certificada de Java 17, Java 11 (solo para SnapCenter 6.2) en el host Linux.
...
Paquetes de software obligatorios
 a| 
Java 17 (Oracle u OpenJDK), Java 11 (solo para SnapCenter 6.2)
...
Paquetes de software obligatorios
 a| 
IBM Java 17, IBM Java 11 (solo para SnapCenter 6.2)
