...
* Debes tener instalado Java 17 (para SnapCenter 6.2.1 y versiones posteriores) o
* Java 11 (para SnapCenter 6.2 y anteriores) en tu host Linux o AIX.
+
** Java de Oracle y OpenJDK son compatibles con Linux.
...
Paquetes de software obligatorios
 a| 
* Java 17 (Oracle u OpenJDK) para SnapCenter 6.2.1 y posteriores o
* Java 11 para SnapCenter 6.2 y anteriores
...
Paquetes de software obligatorios
 a| 
* IBM Java 17 para SnapCenter 6.2.1 y posteriores o
* IBM Java 11 para SnapCenter 6.2 y anteriores
