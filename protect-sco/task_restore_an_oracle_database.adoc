...
** http://["Informe técnico de NetApp 4591: Protección de bases de datos: Backup, recuperación, replicación y DR"^]
** https://["Se produce un error en el funcionamiento con ORA-00308"^]
...
* https://["Error al restaurar desde una ubicación de SnapMirror o SnapVault secundaria"^]
* https://["Se ha producido un error al restaurar desde un backup de una encarnación huérfana"^]
