...
---
= Define una estrategia de copias de seguridad para las bases de datos Oracle en SnapCenter
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
Para obtener la información más reciente sobre las versiones de Oracle compatibles, consulte la https://imt.netapp.com/imt/imt.jsp?components=180338;180332;134509;180320;&solution=1257&isHWU&src=IMT["Herramienta de matriz de interoperabilidad de NetApp"^].
